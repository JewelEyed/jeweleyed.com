...
<div
    class="{isAtTop
        ? 'w-full h-screen'
        : 'w-[90vw] h-[90vh]'} transition-all duration-500 bg-[#081217] flex items-center justify-center drop-shadow-md"
>
    <div
        id="mainHeight"
        class="flex {isAtTop
            ? 'rounded-none'
            : 'rounded-md border-4 border-white'} relative duration-500 justify-center h-full transition-all w-full bg-gradient-to-br from-pink-600 to-yellow-600 text-white text-2xl scroll-smooth"
    >
        <div class="flex justify-center flex-col items-center">
            ...
            <div class="flex">
                ...
                <a
                    href="https://gitlab.com/JewelEyed"
                    target="_blank"
                    rel="me"
                    aria-label="Gitlab"
                    class="hover:rotate-[-360deg] transition-all duration-700 hover:hue-rotate-180 w-10 h-10 p-2 hover:p-0 drop-shadow-lg"
                ...
                <a
                    href="https://bsky.app/profile/jeweleyed.com"
                    target="_blank"
                    rel="me"
                    aria-label="Bluesky"
                    class="hover:rotate-[-360deg] transition-all duration-700 hover:hue-rotate-180 w-10 h-10 p-2 hover:p-0 drop-shadow-lg"
        ...
        <a
            href="#more"
            class="absolute left-2 bottom-2 transition-all {isAtTop
                ? 'opacity-70'
                : 'opacity-0'}"
        >
            <h1>Scroll Down</h1>
